...
function EditarContent() {
  ...
  function handleSuccess(updatedHouse: House) {
    setTimeout(() => {
    ...
    return (
      <div className="p-6">
        <div className="max-w-4xl mx-auto bg-[#0d0d0d] border border-[rgba(239,68,68,0.5)] rounded p-8 text-center">
          <h1 className="font-cormorant text-2xl text-white mb-2">Imóvel não encontrado</h1>
          <p className="text-[rgba(255,255,255,0.5)] font-oswald mb-6">O imóvel que você está procurando não existe.</p>
          <button
  ...
  return (
    <div className="p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="font-cormorant text-4xl text-white mb-2">Editar Imóvel</h1>
        ...
        <div className="bg-[#0d0d0d] border border-[rgba(196,160,80,0.2)] rounded p-8">
          {house && <HouseForm house={house} onSuccess={handleSuccess} />}
        </div>
      </div>
    </div>
  );
